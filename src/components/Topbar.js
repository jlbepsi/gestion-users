              ...
              <div className={classes.inline}>
                <Typography variant="h6" color="inherit" noWrap>
                  <Link to='/' className={classes.link}>
                    <img src={logo} alt={"Logo EPSI"} className={classes.mainLogo}/>
                    <span className={classes.tagline}>EPSI Montpellier</span>
                  </Link>
                </Typography>
              </div>
              { !this.props.noTabs && (
                <React.Fragment>
                  ...
                  <div className={classes.tabContainer}>
                    <SwipeableDrawer anchor="left" open={this.state.menuDrawer} onClose={this.mobileMenuClose} onOpen={this.mobileSwipeMenuOpen} >
                      <AppBar title="Menu" />
                      <List>
                        {Menu.map((item, index) => (
                    ...
                    <Tabs
                      value={this.props.menuIndex || this.state.value}
